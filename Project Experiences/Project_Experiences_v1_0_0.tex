...
\todo{Jag tycker det här är lite väl att ta i, att vi frågade om deliverables fanns med var ju ett misstag, har inget att göra med om vi är på rätt spår eller inte, men det är bra med lite reflektioner över detta hursomhelst. /vem?}
...
\todo{Ska den här texten vara här? Förstår inte sammanhanget, är det tänkt som en sammanfattning/slutsats till feedback conclusions? /Knorn
______

Antar att den bortkommenterade texten betyder att den här issuen är fixad? Vore bra med nån kommentar att den är det.. /Knorn}

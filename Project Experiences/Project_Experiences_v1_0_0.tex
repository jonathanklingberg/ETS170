...
Jag tycker inte det gör något att det tar mycket plats, så ser verkligheten ut idag ;). Men NinjaKommenteraren har rätt, eftersom det finns med i SRS:en kan denna lista vara redundant. Anledningen till att jag tog med det var för att tydligare visualisera utvecklingen av våra kravgrupperingar /Badju}
\begin{itemize}
\item Goals
\item General
\item Safety

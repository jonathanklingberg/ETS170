...
\newline
\indent For R2 we continued to work on the context diagram, as it needed a few changes.  Some of the events/tasks needed to be rewritten so they were expressed on domain level.   

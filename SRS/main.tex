...
\thispagestyle{empty}
\endgroup
\todo{Ska vi lägga till "requirements" i rubrikerna kanske? General requirements, Safety requirements etc. Blir lättare att läsa innehållsförteckningen då. (Goals och Scenarios tycker jag vi skippar det på dock) /Knorn }
\newpage
...
\todo{Jag la in det nya kontextdiagrammet och eftersom det endast finns med end-user föreslår jag att traveler, passenger, driver och owner flyttas ner till terminology. På så sätt bör vi också ändra rubriken här. End-users och samtliga interface borde vi dock beskriva här (eller i samband med bilden av kontextdiagrammet). Alternativt så flyttas kontextdiagrammet och dess beskrivning till ett annat ställe //Nick }
\noindent
...
\textbf{Positioning system} - \\\todo{infoga beskrivning? /Knorn}
...
\todo{All text är alldeles för liten just nu. Vet inte hur vi ska lösa det, men ett förslag att börja med är ju att ändra indragen för hela dokumentet (ser inget vidare ut just nu ändå i mitt tycke) //Nick

Vi kan väl bara bifoga kontextdiagrammet separat annars? Ändå lika bra känner jag. /Badju}
\begin{figure}[htb]    
 \centering
...
\todo{Vad innebar prioritized? /Knorn. Låter jättekonstigt /David}
...
\- \- \-Passengers must be able to unlock the car and initiate transportation
      \subsubsection{Requirement}
\hfill \break 
\- \- \-A driver has\todo{Är det ok med "has" i krav? /Knorn} the same rights as a passenger and must be able to select and change destination address as well as change to and from manual driving mode
      \subsubsection{Requirement}
\hfill \break 
